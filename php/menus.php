...
<link rel="shortcut icon" href="../assets/media/favicon.png" type="image/x-icon">
	<title>FA|MS : Choisissez votre menu</title>
</head>
<body>
<header>
  ...
  <ul class="navbar-nav mr-auto d-flex justify-content-around">
        <li class="nav-item active li"><a class="nav-link" href="accueil.php">Accueil <span class="sr-only">(current)</span></a></li>
        <li class="nav-item "><a class="nav-link" href="carte.php">Carte</a></li>
        <li class="nav-item "><a class="nav-link" href="menus.php">Menus</a></li>
        <li class="nav-item "><a class="nav-link" href="burger.php">Burgers</a></li>
        <li class="nav-item "><a class="nav-link" href="boisson.php">Boissons</a></li>
        <li class="nav-item "><a class="nav-link" href="dessert.php">Desserts</a></li>
        <li class="nav-item "><a class="nav-link" href="../html/form.html" target="blank">Contact</a></li>
...
<nav class="navbar navbar-light navbar-dark bg-dark menu_burger">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent1">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active ml-5 pl-4"><a class="nav-link" href="accueil.php">Accueil <span class="sr-only">(current)</span></a> </li>
      <li class="nav-item ml-5 pl-4"> <a class="nav-link" href="carte.php">Carte</a> </li>
      <li class="nav-item ml-5 pl-4"><a class="nav-link" href="menus.php">Menus</a></li>
      <li class="nav-item ml-5 pl-4"><a class="nav-link" href="burger.php">Burgers</a></li>
      <li class="nav-item ml-5 pl-4"><a class="nav-link" href="boisson.php">Boissons</a></li>
      <li class="nav-item ml-5 pl-4"><a class="nav-link" href="dessert.php">Desserts</a></li>
      <li class="nav-item ml-5 pl-4"><a class="nav-link" href="../html/form.html" target="blank">Contact</a></li>
...
<main>
    ...
    <section>
        ...
        <h1 class="text-center p-5">Menus</h1>
    ...
    <div class="wrapper">
     ...
     <?php
                    /* dessert */
                  include "connect.php";
                  $recupProdDess = $bdd->query('SELECT noms, url_images FROM carte WHERE id_categorie=1');
...
<div class="d-flex justify-content-around">
  <span><a href="../html/form.html" target="_blank">Nous contacter</a></span>
  <span><a href="mention_legales.php">Mentions légales</a></span>
</div>
...
<!-- Linkedin -->
<a class="btn shadow-none btn-floating m-1" href="https://www.linkedin.com/" target="_blank" role="button"
...
<!-- Instagram -->
<a class="btn shadow-none btn-floating m-1" href="https://www.instagram.com/?hl=fr" target="_blank" role="button"
