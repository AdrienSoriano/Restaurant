...
<main class="d-flex justify-content-center align-items-center">
    <h1 class="pt-5">Carte</h1>
    <div class="wrapper">

      <div>
        <a href="../php/menus.php"><img src="../assets/media/menus_icone.svg" class="w-75 mt-4 ml-4 menuresize"></a>
        <h3 class="mt-5 menuresizeh3">Menu</h3>
      </div>
      <div><img src="../assets/media/icone_burger.svg" class="w-50 mt-5 ">
        <h3 class="mt-5 h3resize">Burgers</h3></div>
      <div><img src="../assets/media/icone_cookie.svg" class="w-50 mt-5">
        <h3 class="mt-5">Desserts</h3></div>
      <div><img src="../assets/media/icone_boisson.svg" class="w-50 mt-4">
        <h3 class="mt-4 boissonresize">Boissons</h3></div>
