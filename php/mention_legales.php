...
<link rel="shortcut icon" href="../assets/media/favicon.png" type="image/x-icon">
	...
	<title>FA|MS : Mentions légales</title>
</head>
<body>
<header>
...
<main class=" d-flex flex-column align-items-center">
    ...
    <section>
        ...
        <h1 class="text-center font-weight-bold p-5 mt-5">Mentions légales</h1>

    </section>

    <section class="mentions border border-dark">

        <p class="text-center mt-5 pt-5">Conformément aux dispositions de la loi n° 2004-575 du 21 juin 2004 pour la confiance en l’économie numérique, il est précisé aux utilisateurs du site FA|MS l’identité des différents intervenants dans le cadre de sa réalisation et de son suivi.</p>
        <p class="text-center pt-5">Edition du site</p>
        <p class="text-center">Le site FA|MS est édité par la société FA|MS, société par actions simplifiée au capital de 0,01 euros, dont le siège social est situé 101 rue de vesoul, 25000 Besançon.</p>
        <p class="text-center mt-5 pt-5">Responsable de publication</p>
        <p class="text-center"><span class="pr-5">Florian Moulun</span>     <span class="right pl-5">Adrien Soriano</span></p>
        <p class="text-center mt-5 pt-5">Hébergeur</p>
        <p class="text-center pb-5">Le site FA|MS est hébergé par la société Onlineformapro.</p>
